/** Set the .insta-vector placeholder's innerHTML as inline svg. which is very easy to style using css
 * example
 * .insta-vector svg path { ... }
 */

const $instaVector = document.querySelector('.insta-vector');

$instaVector.innerHTML += `
